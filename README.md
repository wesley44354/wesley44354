...
.custom-div {
        background-image: linear-gradient(to right, #005aa7, #0035a8);
        color: transparent;
...
<div align="center">
     <div class="custom-div">
        <h1>Hello World! Am i Wesley Alves.</h1>
    </div>
  <!-- <p style="color: blue; font-size: 50px;"></p> -->
  <p style="color: white;">🔭 Today I work with Games and Mobile developer as freelancer.</p>
</div>
